...
package com.github.houbb.fake.json.api.impl;


import com.github.houbb.fake.json.api.JsonApi;
import com.github.houbb.fake.json.constant.JsonConstant;
import com.github.houbb.fake.json.exception.JsonRuntimeException;
import com.github.houbb.fake.json.support.config.JsonConfig;
import com.github.houbb.fake.json.utils.CollectionUtils;
import com.github.houbb.fake.json.utils.ObjectUtils;
import com.github.houbb.fake.json.utils.StringUtils;
...
public class JsonApiImpl implements JsonApi {
    ...
    @Override
    public <T> List<T> toArray(String json, Class<T> tClass) {
        return null;
    }
